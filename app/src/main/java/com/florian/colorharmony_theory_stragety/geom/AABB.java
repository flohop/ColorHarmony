...
public class AABB extends Vec3D implements Shape3D {
     ...
     * 
     * @see com.florian.colorharmony_theory_stragety.geom.Vec3D#set(float, float, float)
     */
     ...
     * {@link #updateBounds()} immediately
     * 
     * @see com.florian.colorharmony_theory_stragety.geom.Vec3D#set(com.florian.colorharmony_theory_stragety.geom.Vec3D)
     */
