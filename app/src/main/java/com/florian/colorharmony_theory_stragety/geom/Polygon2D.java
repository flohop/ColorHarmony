...
import com.florian.colorharmony_theory_stragety.geom.Line2D.LineIntersection;
import com.florian.colorharmony_theory_stragety.geom.Line2D.LineIntersection.Type;
import com.florian.colorharmony_theory_stragety.geom.mesh.Mesh3D;
import com.florian.colorharmony_theory_stragety.geom.mesh.TriangleMesh;
...
public class Polygon2D implements Shape2D, Iterable<Vec2D> {
   ...
   /* @XmlElement(name = "v")*/
     ...
     * @see com.florian.colorharmony_theory_stragety.geom.Shape2D#getBounds()
     */
     ...
     * 
     * @see com.florian.colorharmony_theory_stragety.geom.Shape2D#getCircumference()
     */
    ...
    public Mesh3D toMesh(Mesh3D mesh, Vec2D centroid2D, float extrude) {
        ...
        for (int i = 1; i <= num; i++) {
            ...
            //mesh.addFace(com.example.colorharmony.geom.Vec3D.centroid, a.to3DXY(), b.to3DXY(), uvC, uvA, uvB);
        }
        return mesh;
    }
