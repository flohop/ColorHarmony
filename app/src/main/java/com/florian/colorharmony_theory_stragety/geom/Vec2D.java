...
import com.florian.colorharmony_theory_stragety.math.InterpolateStrategy;
import com.florian.colorharmony_theory_stragety.math.MathUtils;
import com.florian.colorharmony_theory_stragety.math.ScaleMap;
...
public class Vec2D implements Comparable<ReadonlyVec2D>, ReadonlyVec2D {
    ...
    public float getComponent(com.florian.colorharmony_theory_stragety.geom.Vec2D.Axis id) {
        switch (id) {
            case X:
                return x;
            case Y:
