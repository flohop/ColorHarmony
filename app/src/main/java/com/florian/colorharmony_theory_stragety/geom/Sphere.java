...
import com.florian.colorharmony_theory_stragety.geom.mesh.SphereFunction;
import com.florian.colorharmony_theory_stragety.geom.mesh.SurfaceMeshBuilder;
...
public class Sphere extends Vec3D implements Shape3D {
    ...
    public Mesh3D toMesh(Mesh3D mesh, int res) {
        SurfaceMeshBuilder builder = new SurfaceMeshBuilder(new SphereFunction(this));
