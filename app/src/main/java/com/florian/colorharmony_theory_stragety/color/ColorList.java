...
import com.florian.colorharmony_theory_stragety.theory.ColorTheoryRegistry;
import com.florian.colorharmony_theory_stragety.theory.ColorTheoryStrategy;
...
public class ColorList implements Iterable<TColor> {
     ...
     *            int array of ARGB pixels
     * @param num
     *            number of colors samples (clipped auRmatically to number of
     *            pixels in the image)
     * @param uniqueOnly
     *            flag if only unique samples are to be taken (doesn't guarantee
     *            unique colors though)
